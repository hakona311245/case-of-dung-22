...
export const photoAssets = {
  ...
  childhood: {
    path: 'images/dung-childhood.jpg',
  ...
  highSchoolGroup: {
    path: 'images/highschool-group.jpg',
  ...
  highSchoolMemory: {
    path: 'images/highschool-memory.jpg',
  ...
  graduation: {
    path: 'images/dung-graduation.jpg',
  ...
  graduationSecondary: {
    path: 'images/dung-graduation-secondary.jpg',
